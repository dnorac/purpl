...
function PrivacyPolicy() {
  ...
  return (
    <Segment basic>
      <Container>
        <Header size="huge">Política de Privacidade</Header>
        <Segment>
          <h2>Privacidade</h2>
          <p>
            A sua privacidade é importante para nós. É política do Purpl
            respeitar a sua privacidade em relação a qualquer informação sua que
            possamos coletar no site{" "}
            <a href="https://www.chaoside.win">Purpl</a>, e outros sites que
          ...
          <h2>Política de Cookies Purpl</h2>
          ...
          <ul>
            <li>
              ...
              <br />
              <br /> Se você criar uma contato conosco, usaremos cookies para o
          ...
          <p>
            ...
            informação que o Purpl oferece no site e com caráter enunciativo,
            mas não limitativo:
          </p>
          ...
          <ul>
            ...
            <li>
              ...
              xenofóbica, casas de apostas, pornografia ilegal, de apologia ao
              terrorismo ou contra os direitos humanos;
            </li>
            <li>
              C) Não causar danos aos sistemas físicos (hardwares) e lógicos
              (softwares) do Purpl, de seus fornecedores ou terceiros, para
