...
function TermsOfService() {
  ...
  return (
    <Segment basic>
      <Container>
        <Header size="huge">Termos e condições de uso</Header>
        <Segment>
          <h2>1. Termos</h2>
          <p>
            Ao acessar ao site <a href="https://www.chaoside.win">Purpl</a>,
          ...
          <p>
            ...
            materiais (informações ou software) no site Purpl , apenas para
          ...
          <ol>
            ...
            <li>
              ...
              software contido no site Purpl;{" "}
            </li>
            <li>
          ...
          <p>
            ...
            dessas restrições e poderá ser rescindida por Purpl a qualquer
          ...
          <ol>
            <li>
              Os materiais no site da Purpl são fornecidos 'como estão'. Purpl
            ...
            <li>
              Além disso, o Purpl não garante ou faz qualquer representação
          ...
          <h2>4. Limitações</h2>
          <p>
            Em nenhum caso o Purpl ou seus fornecedores serão responsáveis ​​por
            ...
            da incapacidade de usar os materiais em Purpl, mesmo que Purpl ou um
            representante autorizado da Purpl tenha sido notificado oralmente ou
          ...
          <p>
            Os materiais exibidos no site da Purpl podem incluir erros técnicos,
            tipográficos ou fotográficos. Purpl não garante que qualquer
            material em seu site seja preciso, completo ou atual. Purpl pode
            fazer alterações nos materiais contidos em seu site a qualquer
            momento, sem aviso prévio. No entanto, Purpl não se compromete a
            atualizar os materiais.
          </p>
          <h2>6. Links</h2>
          <p>
            O Purpl não analisou todos os sites vinculados ao seu site e não é
            responsável pelo conteúdo de nenhum site vinculado. A inclusão de
            qualquer link não implica endosso por Purpl do site. O uso de
            qualquer site vinculado é por conta e risco do usuário.
          </p>
          <h3>Modificações</h3>{" "}
          <p>
            O Purpl pode revisar estes termos de serviço do site a qualquer
          ...
          <p>
            ...
            as leis do Purpl e você se submete irrevogavelmente à jurisdição
