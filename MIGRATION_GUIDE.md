...
- ✅ **nodemon**: ^2.0.6 → ^3.1.4
- ✅ **nanoid**: ^3.1.12 → ^5.0.7
- ✅ **faker** → **@faker-js/faker**: ^8.4.1 (BREAKING CHANGES)
- ✅ **eslint**: ^7.14.0 → ^9.8.0
...
### 4. Faker Library (APPLIED)
- ✅ **Backend**: Updated `require("faker")` → `require("@faker-js/faker").faker`
...
3. Faker library migration in backend
